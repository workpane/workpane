...
class BrowserView final : public QWidget {
  ...
  public:
    explicit BrowserView(BrowserPlugin& plugin, QWidget* parent = nullptr);
  ...
  private:
    [[nodiscard]] QAction* registerAction(const QString& name, const QString& translationKey, const QList<QKeySequence>& shortcuts);
