...
QWidget* TerminalPlugin::createSettingsSection(const QString& groupId, const QString& sectionId, QWidget* parent) {
    ...
    auto* openLinksExternally = new QCheckBox(page);
    openLinksExternally->setObjectName(QStringLiteral("terminalOpenLinksExternally"));
    openLinksExternally->setChecked(m_settings->openLinksInSystemBrowser());
    ...
    ui::Components::addSettingsRow(form, m_host->translate(QStringLiteral("terminal.settings.open-links-externally")), openLinksExternally);
    ...
    connect(openLinksExternally, &QCheckBox::toggled, m_settings.get(), &TerminalSettingsStore::setOpenLinksInSystemBrowser);
    return page;
}
