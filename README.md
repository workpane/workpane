...
<p align="center">
One desktop window for terminals, code, browsing, AI agents and local development services.
</p>
...
Nothing here talks to a service you did not configure, and nothing leaves your machine unless you
point it somewhere. Everything is kept in one SQLite database and comes back exactly as you left it,
down to the terminal layout, the open documents, the browser tabs and the conversation each agent was
having.
...
- [x] Strict SQLite persistence with complete configuration export and import
...
| **Settings**, searchable across every feature | |

## 📚 Documentation

- [Getting started](docs/getting-started.md) — requirements, the first build and where the data lives
- [Architecture](docs/architecture.md) — how the application is put together
- [Features](docs/features.md) — what each feature owns and how they reach each other
