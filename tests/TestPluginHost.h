...
class TestPluginHost final : public plugins::PluginHost {
  public:
    ...
    [[nodiscard]] bool confirm(QWidget*, const QString& title, const QString&, const QString&, const QString&, bool) const override {
        confirmedTitles.append(title);
        return confirmation;
    }
    ...
    mutable QStringList confirmedTitles;
    int schemaVersion{0};
