...
class AiTestsHelper final {
  public:
    ...
    static AiTaskInfoDialog* openTaskSurface(QWidget* view, const QString& objectName);
};

inline AiTaskInfoDialog* AiTestsHelper::openTaskSurface(QWidget* view, const QString& objectName) {
