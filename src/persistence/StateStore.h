...
class StateStore final {
  ...
  private:
    ...
    [[nodiscard]] Result<QSqlQuery> runStatement(const QString& statement, const QVariantList& bindings, const QString& failureCode, const QString& failureMessage) const;
